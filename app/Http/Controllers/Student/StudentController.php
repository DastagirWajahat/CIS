...
class StudentController extends CollegeBaseController
{
    ...
    public function view($id)
    {
        ...
        //     ->first();
            ...
            'students.id', 'students.reg_no', 'students.reg_date', 'students.university_reg',
            'students.faculty', 'students.semester', 'students.batch', 'students.academic_status', 'students.first_name', 
            'students.middle_name', 'students.last_name', 'students.date_of_birth', 'students.gender', 
            'students.blood_group', 'students.religion', 'students.caste', 'students.nationality', 
            'students.mother_tongue', 'students.email', 'students.extra_info', 'students.student_image', 
            'students.student_signature', 'students.status', 
            'parent_details.grandfather_first_name', 'parent_details.grandfather_middle_name', 'parent_details.grandfather_last_name', 
            'parent_details.father_first_name', 'parent_details.father_middle_name', 'parent_details.father_last_name', 
            'parent_details.father_eligibility', 'parent_details.father_occupation', 'parent_details.father_office', 
            'parent_details.father_office_number', 'parent_details.father_residence_number', 'parent_details.father_mobile_1', 
            'parent_details.father_mobile_2', 'parent_details.father_email', 'parent_details.mother_first_name', 
            'parent_details.mother_middle_name', 'parent_details.mother_last_name', 'parent_details.mother_eligibility', 
            'parent_details.mother_occupation', 'parent_details.mother_office', 'parent_details.mother_office_number', 
            'parent_details.mother_residence_number', 'parent_details.mother_mobile_1', 'parent_details.mother_mobile_2', 
            'parent_details.mother_email', 'parent_details.father_image', 'parent_details.mother_image',
            'addressinfos.address', 'addressinfos.state', 'addressinfos.country', 'addressinfos.temp_address', 
            'addressinfos.temp_state', 'addressinfos.temp_country', 'addressinfos.home_phone', 'addressinfos.mobile_1', 
            'addressinfos.mobile_2', 'guardian_details.id as guardians_id', 'guardian_details.guardian_first_name', 
            'guardian_details.guardian_middle_name', 'guardian_details.guardian_last_name', 'guardian_details.guardian_eligibility', 
            'guardian_details.guardian_occupation', 'guardian_details.guardian_office', 'guardian_details.guardian_office_number', 
            'guardian_details.guardian_residence_number', 'guardian_details.guardian_mobile_1', 'guardian_details.guardian_mobile_2', 
            'guardian_details.guardian_email', 'guardian_details.guardian_relation', 'guardian_details.guardian_address', 
            'guardian_details.guardian_image'
        )
        ->leftJoin('parent_details', 'parent_details.id', '=', 'students.id')
        ->leftJoin('addressinfos', 'addressinfos.id', '=', 'students.id')
        ->leftJoin('student_guardians', 'student_guardians.id', '=', 'students.id')
        ->leftJoin('guardian_details', 'guardian_details.id', '=', 'student_guardians.guardians_id')
        ->where('students.id', $id)
        ->first();
