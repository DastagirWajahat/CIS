...
Route::get('/get-semesters/{facultyId}', ['as' => 'get-semesters', 'uses' => 'Student\StudentPublicController@getSemesters']);
...
/* Form Page Routes */
Route::get('form-page', ['as' => '.form.create', 'middleware' => ['ability:super-admin,form-create'], 'uses' => 'FormController@create']);

/* Form Page Routes */

Route::get('form-page', [App\Http\Controllers\FormController::class, 'create'])->name('form.create');
Route::post('form-page/store', [App\Http\Controllers\FormController::class, 'create'])->name('form.store');
