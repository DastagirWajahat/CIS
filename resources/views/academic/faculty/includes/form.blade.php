<div class="form-group">
    {!! Form::label('faculty', 'Department', ['class' => 'col-sm-4 control-label']) !!}
    <div class="col-sm-8">
        {!! Form::text('faculty', null, ["placeholder" => "e.g. Computer Science", "class" => "form-control border-form upper","required"]) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        {!! Form::text('faculty_code', null, ["placeholder" => "e.g. CSE","class" => "form-control border-form upper","required"]) !!}
